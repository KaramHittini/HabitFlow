    ...
    >
      ...
      {toast.undoFn && (
        <button
          ...
          style={{ color: 'var(--accent-blue)', background: 'rgba(79,142,247,0.12)' }}
        >
          Undo
        </button>
      )}
...
export function ToastContainer() {
  ...
  return (
    <div className="fixed bottom-24 md:bottom-6 z-[100] flex flex-col items-center gap-2 pointer-events-none"
